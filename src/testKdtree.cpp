...
int main(int argc, char **argv) {
    ...
    mnist_load("data/train-images-idx3-ubyte", "data/train-labels-idx1-ubyte", &rawTrainData, &trainCnt);
    mnist_load("data/t10k-images-idx3-ubyte", "data/t10k-labels-idx1-ubyte", &rawTestData, &testCnt);
